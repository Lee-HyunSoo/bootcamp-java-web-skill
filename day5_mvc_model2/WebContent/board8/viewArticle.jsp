...
<script type="text/javascript">
	 ...
	 function fn_remove_article(url,articleNO){
		 ...
		 form.setAttribute("action", url); // <form action='url'>
	     var articleNOInput = document.createElement("input"); // <input></input>
	     articleNOInput.setAttribute("type","hidden"); // <input type='hidden'>
	     articleNOInput.setAttribute("name","articleNO"); // <input name='articleNO'>
	     articleNOInput.setAttribute("value", articleNO); // <input value='articleNO'>
		 
	     form.appendChild(articleNOInput); // form 태그의 자식으로 input 추가
	     document.body.appendChild(form); // form 태그를 body 태그 내부에 추가
	     form.submit();
	 }
	 ...
	 // ${contextPath}/board/replyForm.do~
